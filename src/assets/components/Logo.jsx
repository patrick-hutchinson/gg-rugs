...
export default function Logo() {
  ...
  React.useEffect(() => {
    ...
    let element = document.querySelector(".letter > img");
    ...
    Object.values(letters).forEach((letter) => {
      ...
      for (let i = 1; i < letter.letterPoints.length + 1; i++) {
        ...
        let currentLetterContainer = `.letterContainer_${letter.character}`;

        document.querySelectorAll(currentLetterContainer).forEach((letterContainer) => {
  ...
  window.addEventListener("mousemove", (e) => {
    ...
    document.querySelectorAll(".letter_point").forEach((letterPoint) => {
